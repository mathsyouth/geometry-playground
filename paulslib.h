 ...
 *
 * $Id: paulslib.h 5786 2012-10-09 01:47:31Z dbarnes $
 *
 */
...
XYZ    ArbitraryRotateUnit(XYZ,double,XYZ);
...
/* POLYGON STUFF -----------------------------------------------------*/
#if defined(S2TRIPLEFLOAT)
void   PlaneParam(XYZ *,float *,float *,float *,double *);
#else
...
int    FFT2D(pCOMPLEX **, int,int,int);
...
/* pCOMPLEX NUMBERS  -------------------------------------------*/
pCOMPLEX Csqrt(pCOMPLEX);
pCOMPLEX Clog(pCOMPLEX);
pCOMPLEX Cexp(pCOMPLEX);
pCOMPLEX Csin(pCOMPLEX);
pCOMPLEX Ccos(pCOMPLEX);
pCOMPLEX Ctan(pCOMPLEX);
pCOMPLEX Casin(pCOMPLEX);
pCOMPLEX Cacos(pCOMPLEX);
pCOMPLEX Catan(pCOMPLEX);
pCOMPLEX Csinh(pCOMPLEX);
pCOMPLEX Ccosh(pCOMPLEX);
pCOMPLEX Ctanh(pCOMPLEX);
pCOMPLEX Casinh(pCOMPLEX);
pCOMPLEX Cacosh(pCOMPLEX);
pCOMPLEX Catanh(pCOMPLEX);
pCOMPLEX Cadd(pCOMPLEX,pCOMPLEX);
pCOMPLEX Csub(pCOMPLEX,pCOMPLEX);
pCOMPLEX Cmult(pCOMPLEX,pCOMPLEX);
pCOMPLEX Cmultd(pCOMPLEX,double);
pCOMPLEX Cdiv(pCOMPLEX,pCOMPLEX);
pCOMPLEX Cinv(pCOMPLEX);
pCOMPLEX Cdivd(pCOMPLEX,double);
pCOMPLEX Cpowd(pCOMPLEX,double);
double  Cabs(pCOMPLEX);
